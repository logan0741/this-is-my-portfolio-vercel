...
export default function ActivityBlock({ activity }: ActivityBlockProps) {
  ...
  const handleClick = () => {
    router.push(`/portfolio/${activity.id}`);
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        {/* Navigate hint */}
        <span className="text-[10px] text-[var(--text-tertiary)] opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1">
          자세히 보기
